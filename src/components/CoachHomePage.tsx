...
export function CoachHomePage() {
  ...
  if (showProfile) {
    return <CoachProfilePage onBack={() => setShowProfile(false)} />;
  }
  ...
  const handleSendFeedback = (athleteId: string) => {
  ...
  const handleProfileClick = (athleteId: string) => {
    ...
    const publicUser: PublicUser = {
      ...
      email: `${video.athleteName.toLowerCase().replace(' ', '.')}@outlook.com`,
      club: "Athletic Club",
      height: "6'1\" (185 cm)",
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black pb-20">
      ...
      {showFeedbackModal && selectedAthleteId && (
        <SendFeedbackModal
