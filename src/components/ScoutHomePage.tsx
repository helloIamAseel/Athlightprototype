...
import { ScoutProfilePage } from "./ScoutProfilePage";
...
export function ScoutHomePage() {
  ...
  if (showProfile) {
    return <ScoutProfilePage onBack={() => setShowProfile(false)} />;
  }
  ...
  const handleProfileClick = (athleteId: string) => {
    ...
    const publicUser: PublicUser = {
      ...
      email: `${video.athleteName.toLowerCase().replace(' ', '.')}@hotmail.com`,
      club: "Athletic Club",
      height: "6'1\" (185 cm)",
